 ...
 *
 * @author Dr. Gallagher
 * @version 1.0 Created: 22 Apr 03 Summary of Modifications: 29 Apr 03 - DMG -
 * New constructor added which just takes type as an arg We don't need to pass
 * the block anymore, because the appendOper() method of the BasicBlock will set
 * the Operations block 1 May 03 - DMG - Fixed bug in new constructor added 29
 * Apr
 *
 * Description: An Operation is the basic internal representation of an assembly
 * language instruction. Early in the back-end, Operations are generic and don't
 * necessarily map 1:1 with assembly. As the low-level code gets more
 * architecture-specific, Operations should become more and more a 1:1 mapping
 * with assembly. An Operation maintains next/prev references, so a block can
 * contain a list of Operations. The Operation also maintains sets of Operands.
 * To keep it general, we employ arrays of src and dest Operands.
 */
public class Operation {

    public enum OperationType {
        UNKNOWN, FUNC_ENTRY, FUNC_EXIT, ASSIGN, ADD_I,
