 ...
 *
 * @author Dr. Gallagher
 * @version 1.0 Created: 22 Apr 03 Summary of Modifications:
 *
...
public class Function extends CodeItem {
    ...
    /**
     *
     * @return BasicBlock which is the current block; i.e., the block that code
     * should be placed within during code generation
     */
    ...
    /**
     *
     * @param param - the FuncParam which is the head of the list of FuncParams
     */
     ...
     * function; i.e., all return statements should generate jumps to this
     * block.
     */
    ...
    /**
     * This method is used by the Block constructor to number blocks in order
     * created. It probably should only be used by this constructor.
     *
     ...
     * start with the FUNC_ENTRY operation. Subsequent code can be added to this
     * block, or the user could decide to close this block out and add any code
     * to a subsequent block. It should be added to the main chain of BBs.
     */
     ...
     * return block. The user should not need to add further code to this block.
     */
    ...
    /**
     *
     * @param newBlock - block to be appended to main chain. This method
     * supports adding a block to the "main" path through code. It will probably
     ...
     *
     * @param newBlock - block to be appended to the current block This method
     * will be the most frequently used of the 3. It is used when you don't know
     * if you are generating code for the "main" path or the "unconnected" path
     * - you just know that you need to append relative to the current block.
     */
     ...
     *
     * @param newBlock - block to be appended to unconnected chain This method
     * is used when you know the block you are appending definitely goes on the
     * "unconnected" list. An example might be when you put your "else" block on
